...
import ModalProfilPrivilege from '../../../../components/ModalProfilPrivilege';
...
export default function ListeUtilisateurs() {
  ...
  return (
    <div>
      ...
      <ModalProfilPrivilege open={openModalEditer} handleClose={handleCloseModalEditer} editerBtn={editerBtn} setEditerBtn={setEditerBtn} />
    </div>
  );
}
